		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "SAP ABAP application",
									"targetURL": "#comexamplepro2pro2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comexamplepro2pro2-display": {
								"semanticObject": "comexamplepro2pro2",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.example.pro2.pro2",
									"url": sap.ui.require.toUrl("com/example/pro2/pro2")
								}
							}
						}
					}
